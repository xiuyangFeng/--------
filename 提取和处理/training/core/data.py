...
class FieldGraphDataset(Dataset):
    def __init__(
        ...
        agent_debug_log(
            run_id="code-audit",
            hypothesis_id="H3_dataset_split_integrity",
            location="training/core/data.py:FieldGraphDataset.__init__",
            message="dataset_load_summary",
            data={
                "requested_cases": len(case_names),
                "missing_cases": missing_cases,
                "loaded_graph_files": len(self.data_files),
                "graphs_subdir": graphs_subdir,
                "augment": bool(augment),
                "translation_prob": float(self.augment_config.get("translation_prob", 0.0)),
                "wss_target_frame": wss_target_frame,
                "wss_domain_norm": wss_domain_norm,
            },
            max_count=12,
        )
        # endregion
