...
7. **下一优先**：`A-Abl-02`：以 **`A-Opt-05` 为母版** 补齐显式几何分量消融（**`A-Opt-07` 已于 2026-04-02 闭环，结论为负**—不再与 02 二选一）
...
建议先把 `A-Opt-01 ~ A-Opt-07` 作为近期主线，其余根据结果再决定是否进入正式执行。**（2026-04-02）`A-Opt-07` 已归档**：结论为**负**，后续主线仍以 **`A-Opt-05`** 为母版，优先 **`A-Abl-02` / Line G**。
