#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Compare current bifurcation origin with the experimental flow-divider origin."""
...
from .registration import compute_transform, untraced_inlet_crop_masks, AXIS_INDEX
...
def _load_pair(label: str):
    ...
    base_cfg = C.registration_for_case(cohort_rel, case_name, C.DEFAULT.registration)
