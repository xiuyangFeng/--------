...
用法：
    ...
    $PY -m pipeline_wss_min.visualize_lr_check --split split_AG_wss_min_v1 --n 20
    # 旧口径对照
...
from .registration import compute_transform, _select_wall_branch_side
...
def _aligned_wall(case: str, reg_cfg, use_case_overrides: bool = True) -> Tuple[np.ndarray, object] | Tuple[None, None]:
    ...
    if use_case_overrides:
        reg_cfg = C.registration_for_case(cohort, name, reg_cfg)
