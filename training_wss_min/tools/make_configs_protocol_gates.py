...
def main():
    ...
    manifest_b0 = SWEEPS_DIR / "protocol_gates_b0_s1234.txt"
    manifest_b0.write_text(repo_config_path("r4_dev1_b0_tgtw_batchq_s1234") + "\n")
    manifest_all = SWEEPS_DIR / "protocol_gates_all.txt"
