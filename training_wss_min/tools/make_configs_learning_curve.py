...
用法：
  python -m training_wss_min.tools.make_configs_learning_curve --min-lr 2e-4 --seeds 1234 [--write]
...
产物（--write 时才落盘）：
  ...
  training_wss_min/configs/fit_lc_diagnosis/lc/lc_<chain>_<size>_s<seed>.json
...
from training_wss_min.tools.config_paths import config_path
from training_wss_min.tools.make_v2_dev_splits import compute_fold_stats
...
CFG_DIR = ROOT / "training_wss_min" / "configs" / "fit_lc_diagnosis" / "lc"
